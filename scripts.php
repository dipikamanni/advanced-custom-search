...
class AASKP_SearchData
{
    public function __construct()
    {
        ...
        //add_action('in_admin_header', array($this, 'AASKP_pageSearchJavascript'));
    ...
    //  public function AASKP_pageSearchJavascript()
    // {
    //     echo '<script type="text/javascript"> AASKP_pageSearch(); </script>';
    // }
